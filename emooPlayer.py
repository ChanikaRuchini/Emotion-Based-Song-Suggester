...
from mediastore import songAdder
from mediastore.musicdb import MusicDb
from faceimage import faceEmotion
from mediastore.playerController import playerController
...
class StartPage(tk.Frame):
    def __init__(self,parent,controller,musicdb):
        ...
        but1=Button(self,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=self.getImage,text='Open Cam',font=('helvetica 15 bold'))
        but1.place(x=120,y=100)
        addButton = tk.Button(self, text=" TAKE PHOTO ", fg='red',font=24,command = self.getImage)
       
        label1 = tk.Label(self,text = "\n\nWelcome to the Emo player\nPlay songs which fix yoyr mood ", fg='green', font="Times 24")
    ...
    def getImage(self):
        ...
        while(count!=1):
            ...
            if emotion ==" ":
            	lbl3=Label(self,padx=5,width=100,bg="dim gray",fg='white',relief=GROOVE,text="\n\nNO face Detected. Try Again!!",font=('helvetica 15 bold'))
            	lbl3.place(x=20,y=500,relx=0.5,anchor=CENTER)
            #IF Face is detected show emotion type	
            else:
            	lbl3=Label(self,padx=5,width=100,bg="dim gray",fg='red',relief=GROOVE,text="\n\nYour current emotion :  "+emotion,font=('helvetica 15 bold'))
            	lbl3.place(x=20,y=500,relx=0.5,anchor=CENTER)
            	
            	but3=Button(self,padx=5,pady=5,width=39,fg='black',relief=GROOVE,text='Generate Playlist ',command=lambda:self.controller.show_frame(PlayerWindow),font=('helvetica 15 bold'))
...
class ViewerWindow(tk.Frame):
    def __init__(self,parent,controller,musicdb):
        ...
        BGlabel.image = logo
        BGlabel.place(x=0,y=0)
        but1=Button(self,padx=5,pady=5,width=10,fg='black',relief=GROOVE,command=lambda : self.viewSong("all"),text='All Songs ',font=('helvetica 15'))
        but1.place(x=50,y=104)
        but2=Button(self,padx=5,pady=5,width=10,fg='black',relief=GROOVE,command=lambda :self.viewSong("happy"),text='Happy Songs',font=('helvetica 15 bold'))
        but2.place(x=200,y=104)
        but3=Button(self,padx=5,pady=5,width=10,fg='black',relief=GROOVE,command=lambda :self.viewSong("sad"),text='Sad Songs',font=('helvetica 15 bold'))
        but3.place(x=350,y=104)
        but4=Button(self,padx=5,pady=5,width=10,fg='black',relief=GROOVE,command=lambda :self.viewSong("calm"),text='Calm Songs',font=('helvetica 15 bold'))
    ...
    def  viewSong(self,emotiontype):
        ...
        global statusbar
        statusbar = ttk.Label(self, text="Welcome to Emoo Music", relief=SUNKEN,width=720, anchor=W, font='Times 10 italic')
        ...
        but5=Button(self,padx=5,pady=5,width=20,fg='black',relief=GROOVE,command=lambda:self.controller.show_frame(StartPage),text='Back To Home',font=('helvetica 15 bold'))
...
class PlayerWindow(tk.Frame):
    def __init__(self,parent,controller,musicdb):
        ...
        BGlabel.image = logo
        BGlabel.place(x=0,y=0)
        lbl1=Label(self,padx=5,width=100,bg="dim gray",fg='white',relief=GROOVE,text="\n\nWe are genrating playlist according to your detected emotion type",font=('helvetica 15 bold'))
        lbl1.place(x=20,y=130,relx=0.5,anchor=CENTER)
        but1=Button(self,padx=5,pady=5,width=10,bg='white',fg='black',relief=GROOVE,command=self.continuee,text='Continue',font=('helvetica 15 bold'))
        but1.place(x=120,y=180)
        but2=Button(self,padx=5,pady=5,width=10,bg='white',fg='black',relief=GROOVE,text='Back',command=self.clear,font=('helvetica 15 bold'))
